...
def loadMovieNames():
    movieNames = {}
    with open("/content/drive/MyDrive/BigData/ml-100k/ml-100k/u.item",encoding = "ISO-8859-1") as f:
        for line in f:
            fields = line.split('|')
...
data = sc.textFile("/content/drive/MyDrive/BigData/ml-100k/ml-100k/u.data")
